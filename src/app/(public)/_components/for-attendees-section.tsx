...
const attendeeFeatures = [
  {
    ...
    description: "Find events that match your interests with smart recommendations and powerful filters.",
    gradient: "from-pink-500 to-rose-500",
  },
  {
    icon: Ticket,
    title: "Easy Registration",
    description: "Register in seconds with a frictionless checkout. Your tickets are always in your pocket.",
    gradient: "from-violet-500 to-purple-500",
  },
  {
    icon: CalendarCheck,
    title: "Personal Agenda",
    description: "Build your custom schedule for multi-session events. Never miss a session you care about.",
    gradient: "from-emerald-500 to-green-500",
  },
  {
    icon: MessageSquare,
    title: "Live Interaction",
    description: "Participate in polls, Q&A sessions, and live chats. Your voice matters at every event.",
    gradient: "from-amber-500 to-orange-500",
  },
  {
    icon: Users,
    title: "Networking",
    description: "Connect with other attendees, exchange contacts, and build meaningful relationships.",
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    icon: Trophy,
    title: "Gamification",
    description: "Earn points, climb leaderboards, and unlock rewards by participating in events.",
